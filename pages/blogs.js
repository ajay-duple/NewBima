...
export default function blogs() {
    ...
    let handleBlogClick = async (blogId) => {
        console.log("Helo...", blogId)
        router.push({ pathname: '/blog-detail', query: { id: blogId } })
    }
        ...
        <div className='blogList '>
            <div className='bg-yellowLight blogListBg'>
                <div className='container pb-5'>
                    <div className='blogListHero text-center d-flex justify-content-center flex-column'>
                        <h1 className='title20 font-weight-600 font-secondary'>The blog</h1>
                    ...
                    <div className='row py-md-5 py-3 pe-md-5'>
                        <div className='col-md-12'>
                            <h4 className='title16 px-md-5 pe-md-0 px-4 font-secondary font-weight-600 mb-lg-4 mt-2 mt-md-0  '>Choose the news from different genres</h4>
                        </div>
                        <div className='col-md-12'>
                            <div className='bloglistCategory mb-3'>
                                <div className='row align-items-center'>
                                    <div className='col-lg-8 pe-0 pe-lg-5'>
                                        <div className='px-md-5 pe-0 ps-4 position-relative d-flex align-items-center'>
                                    ...
                                    <div className='col-lg-4 mt-4 mt-md-0'>
                                        <form>
                                            <div class="form-group px-4 px-md-0">
                                                <div class="input-group border-primary">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text pe-0 ps-4 h-100 bg-transparent border-0">
                                                            <Search iconColor="primary" width="12" height="12" />
                                                        </div>
                                                    </div>
                                                    <input
                                                        type="text"
                                                        class="form-control bg-transparent h-100 radius-0 border-0"
                                                        placeholder="Search"
                                                        value={searchText}
            ...
            <div className='container blogListCard-container'>
                ...
                <div className="pagination-list blogPagination mb-5 pb-5">
                    <ReactPaginate
                        previousLabel={"Prev"}
                        nextLabel={"Next"}
                        breakLabel={". . ."}
            ...
            <div className='container blogSubscribe text-center d-block d-md-none'>
